                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className='text-center py-4'>
                        <div className='text-[#162A43] font-semibold text-5xl font-sans'>
                            <h1 className='leading-snug'>See What Our <span className='text-[#1363DF]'> Happy Customers </span>Have To Say  </h1>
                        </div>
                        ...
                        <div className="relative lg:ml-10">
                            ...
                            <blockquote className="relative">
                                <div className="text-2xl font-medium leading-9 text-gray-900">
                                    <p>
                                        “Very easy to work with, the girls were very kind and understanding, job was done to a very good standard!”
                                    </p>
                                </div>
