...
import p3_s2_img1 from '../../../Images/Page3/Section2/Page3 Section2 Image1.png';
                    ...
                    <div className='grid grid-cols-2 gap-x-12' >
                        ...
                        <div className='space-y-8 py-10 col-span-1 mt-8'>
                            <div className='text-[#162A43] text-5xl font-medium font-sans '>
                                Professional <span className='text-[#5093F7]'>Cleaning Service!</span>
                            </div>
                            ...
                            <div>
                                <div className='text-[#162A43] text-2xl font-bold flex items-center tracking-wider'>
                                    ...
                                    <h1>Visit Onsite Fully Equipped</h1>
                                </div>
                        ...
                        <div className='col-span-1 relative -right-16'>


                            <div>
                                <img className='mt-24' src={p3_s2_img1} alt="" />
                            </div>
